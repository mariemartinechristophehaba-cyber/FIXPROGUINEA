"""FixPro - Plateforme de mise en relation artisans-clients (Guinée).

Ce module regroupe la logique métier (classes et fonctions) ainsi que
l'interface console. La connexion à la base de données et le menu ne sont
lancés que lorsque le module est exécuté directement (``python fixpro.py``),
ce qui permet d'importer et de tester les classes/fonctions sans ouvrir de
connexion MySQL.
"""
...
def connecter_bd():
    """Établir la connexion à MySQL à partir des variables d'environnement."""
    ...
    return connexion, db_host, db_name
...
def main():
    """Point d'entrée : connexion à la base et lancement du menu."""
    print("=" * 50)
    ...
    try:
        connexion, db_host, db_name = connecter_bd()
